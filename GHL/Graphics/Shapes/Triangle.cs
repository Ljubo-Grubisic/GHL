...
namespace GHL.Graphics
{
    public class Triangle : ConvexShape
    {
        ...
        public Triangle(float x, float y, float distance) : base(3)
        {
            ...
            Vertices = MathHelper.CalculateVerticiesEquilateral(distance);
        }
        ...
        {
            Position = new Vector2f(x, y);
            Vertices = MathHelper.CalculateVerticiesIsosceles(distance, distanceIsceles);
        }
        ...
        {
            SetPoint(0, Vertices[0] + Position);
            SetPoint(1, Vertices[1] + Position);
            SetPoint(2, Vertices[2] + Position);
        }
    }
}
